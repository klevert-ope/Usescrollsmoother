 ...
 * Default is false.
 * @property {string,boolean,array} effects - if true, ScrollSmoother will find all elements that have a data-speed and/or data-lag attribute and apply those effects accordingly so that they move at the designated speed or delay, so data-speed="0.5" would scroll at half the normal speed, and data-speed="2" would scroll at twice the normal speed.
 * data-lag="0.8" would take 0.8 seconds to "catch up" to the smoothed scroll position.
 * You can also use selector text or an Array of elements,
 * so effects: ".box" would only look for the attributes on elements with the ".box" class.
